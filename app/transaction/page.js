        ...
        <main className="min-h-screen w-full p-5  items-baseline justify-center">
            ...
            <div className="min-h-screen w-full lg:px-28 flex items-baseline justify-center">
                <div className="bg-white p-8 rounded-xl shadow-lg w-full">
                    <h2 className="text-4xl mb-4">Transaction</h2>

                    <div className="mt-8">
                        <label className="block mb-2 text-lg font-medium text-gray-600" htmlFor="address">Enter Transaction Hash</label>
                        <div className="flex">
                            <input
                                type="text"
                                id="address"
